...
export default function AdminCustomers() {
  ...
  const fetchCustomers = async () => {
    try {
      ...
      console.error("Error in loading customers", err);
    }
  };

  // Toggle expand to show orders
  ...
  if (loading)
    return <p className="text-center mt-10 text-white">Loading customers...</p>;
                      ...
                      <tr className="bg-[#1e293b]">
                        <td colSpan="6" className="p-4">
                          {userOrders.length > 0 ? (
                            ...
                            <p className="text-gray-400">No orders for this user.</p>
                          )}
                        </td>
                      </tr>
                    )}
